...
class FakeBlobClient:
    ...
    def list_files(self, project_id=None):  # type: ignore[no-untyped-def]
...
def test_success_single_file():
    ...
    blob = FakeBlobClient(list_success=True, file_list=["doc1.pdf"], download_success=True, delete_success=True)
...
def test_partial_failure_two_files():
    ...
    blob = FakeBlobClient(list_success=True, file_list=["good.pdf", "bad.pdf"], download_success=True, delete_success=True)
